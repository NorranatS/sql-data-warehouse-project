...
BEGIN
	PRINT '>> Truncate And Load Table: silver.crm_cust_info'
	...
	PRINT '>> Truncate And Load Table: silver.crm_prd_info'
	...
	PRINT '>> Truncate And Load Table: silver.crm_sales_details'
	...
	PRINT '>> Truncate And Load Table: silver.erp_cust_az12'
	...
	PRINT '>> Truncate And Load Table: silver.erp_loc_a101'
	...
	PRINT '>> Truncate And Load Table: silver.erp_px_cat_g1v2'
